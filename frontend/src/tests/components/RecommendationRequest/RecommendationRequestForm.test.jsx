...
describe("RecommendationRequestForm tests", () => {
    ...
    test("renders correctly when passing in initialContents", async () => {
        ...
        expect(await screen.findByTestId(/RecommendationRequestForm-id/)).toBeInTheDocument();
    ...
    test("Correct error messsages on bad input", async () => {
        ...
        expect(await screen.findByText(/RequesterEmail must be a valid email./)).toBeInTheDocument();
        expect(screen.getByText(/ProfessorEmail must be a valid email./)).toBeInTheDocument();
    });
