...
public class ArticlesControllerTests extends ControllerTestCase {
    ...
    mockMvc
        .perform(
            post("/api/articles/post")
                ...
                .param("explanation", "A test article")
        ...
        mockMvc
            .perform(
                post("/api/articles/post")
                    ...
                    .param("explanation", "First explanation")
  ...
  public void admin_can_edit_an_existing_article() throws Exception {
    ...
    when(articlesRepository.findById(eq(10L))).thenReturn(Optional.of(articleOrig));
    ...
    // assert
    verify(articlesRepository, times(1)).findById(10L);
  ...
  public void admin_cannot_edit_article_that_does_not_exist() throws Exception {
    ...
    when(articlesRepository.findById(eq(10L))).thenReturn(Optional.empty());
    ...
    verify(articlesRepository, times(1)).findById(10L);
    Map<String, Object> json = responseToJson(response);
    assertEquals("Articles with id 10 not found", json.get("message"));
  }
