...
|---------------------------|--------------------|---------------------|
| UCSBDiningCommonsMenuItem |Kalyan Rajavaram    |kalyanrajavaram      |
| UCSBOrganization          |Raymond Xie         |POWERTRICEPS         |
| RecommendationRequest     |Hrithik Mereddy     |Hrithik-M            |
| MenuItemReview            |Alexandru Gherghescu|alexandrugherghescu01|
| HelpRequest               |                    |                     |
| Articles                  | Alex Liu           |applebee1558         |
